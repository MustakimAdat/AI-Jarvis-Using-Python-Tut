from selenium import webdriver #paste "pip install selenium" in cmd
...
from selenium import webdriver
import pandas as pd #paste "pip install pandas" in cmd
...
ListWeb = {'mom': "+919966994600",
            "vighnesh": "+918668438209"}
...
def WhatsappSender(Name):
    ...
    sleep(5)
    try:
        driver.find_element(by=By.XPATH,value='/html/body/div[1]/div/div/div[5]/div/footer/div[1]/div/span[2]/div/div[2]/div[2]').click()
        Speak("Message Sent")
