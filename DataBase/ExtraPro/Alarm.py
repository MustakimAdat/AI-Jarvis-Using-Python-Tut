...
extracted_time = open('C:\\Users\\HP\\Desktop\\AI Jarvis Using Python Tut\\Data\\data_time.txt','rt')
time = extracted_time.read()
Time = str(time)

delete_time = open("C:\\Users\\HP\\Desktop\\AI Jarvis Using Python Tut\\Data\\data_time.txt",'r+')
